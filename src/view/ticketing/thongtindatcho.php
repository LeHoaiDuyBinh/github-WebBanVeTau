                        ...
                        <?php if (isset($arr)) : ?>
                            ...
                            <table id="booking-info-table">
                                <thead class="et-table-header">
                                    <tr>
                                        <th style="width: 12%;" class="ng-binding">Họ tên</th>
                                        <th style="width: 12%;" class="ng-binding">Số CCCD/CMND</th>
                                        <th style="width: 8%;" class="ng-binding">Loại chỗ</th>
                                        <th style="width: 6%;" class="ng-binding">Mã tàu</th>
                                        <th style="width: 6%;" class="ng-binding">Mã toa</th>
                                        <th style="width: 10%;" class="ng-binding">Mã chổ ngồi</th>
                                        <th style="width: 18%;" class="ng-binding">Tuyến</th>
                                        <th style="width: 10%;" class="ng-binding">Thời gian</th>
                                        <th style="width: 12%;" class="ng-binding">PTTT</th>
                                    </tr>
                                </thead>
                                <tbody>

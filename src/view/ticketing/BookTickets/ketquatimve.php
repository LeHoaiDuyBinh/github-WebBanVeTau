...
<div class="body-page row row-body">
    ...
    <div class="colume1">
        ...
        <div class="text">
            <h1 class="title" style="text-transform: uppercase; color: #01b3a7; text-align: center; margin-top: 10px !important; padding: 10px !important"><strong>Chiều đi</strong></h1>
            <? if ($arrChuyen[0] != NULL) { ?>
                <table id="myTable">
                    <thead>
